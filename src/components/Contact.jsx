    ...
    <section id="contact" className="py-16 lg:py-24 bg-gray-50" aria-labelledby="contact-heading">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <p className="text-gold-600 font-semibold text-sm uppercase tracking-widest mb-2">Contact</p>
          <h2 id="contact-heading" className="section-title">
            Get In Touch
          </h2>
          <p className="section-subtitle max-w-xl mx-auto">
            Ready to buy, sell or rent? Reach out to Ravindra Singh directly.
          </p>
        </div>
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-white/60 text-sm">Property Consultant</p>
                </div>
              </div>
