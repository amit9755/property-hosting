    ...
    <section id="properties" className="py-16 lg:py-24 bg-white" aria-labelledby="properties-heading">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <p className="text-gold-600 font-semibold text-sm uppercase tracking-widest mb-2">{t.sections.listingsLabel}</p>
          <h2 id="properties-heading" className="section-title">
            {t.sections.listingsTitle}
          </h2>
          <p className="section-subtitle max-w-2xl mx-auto">
            {t.sections.listingsIntro}
          </p>
        ...
        <div className="text-center bg-navy-900 rounded-2xl py-10 px-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            >
              {t.sections.callNow} Ravindra Singh
            </a>
          </div>
        </div>
      </div>
